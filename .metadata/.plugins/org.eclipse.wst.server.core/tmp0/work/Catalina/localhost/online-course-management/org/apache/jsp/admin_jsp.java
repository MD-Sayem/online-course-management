 ...
 * Generated at: 2023-05-15 03:58:58 UTC
...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("cse.web.User");
  }
...
ArrayList<User> teacherList=(ArrayList<User>)request.getAttribute("teacherList");
      ...
      out.write("	<link rel=\"stylesheet\" type=\"text/css\" href=\"./public/admin.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      ...
      out.write("				\n");
      out.write("				<span><h1>Admin</h1></span>\n");
      ...
      out.write("						<th>Teacher's Name</th>\n");
      out.write("					</tr>\n");
      out.write("				</thead>\n");
      out.write("        \n");
      out.write("				<tbody>\n");
 ...
 for(int k=0; k<courseList.size(); k++){ 
      ...
      out.write("						<td></td>\n");
      out.write("						<td>");
      out.print( courseList.get(k).courseId );
      out.write(" </td>\n");
      out.write("						<td>");
      out.print( courseList.get(k).getCourseName() );
      out.write(" </td>\n");
      out.write("						<td>");
      out.print( courseList.get(k).getCredit() );
      out.write(" </td>\n");
      out.write("						<td>");
      out.print( courseList.get(k).getTeacherName() );
      out.write("</td>\n");
      out.write("					</tr>\n");
      out.write("				");
} 
      ...
      out.write("					<tr >\n");
      out.write("						<td> </td>\n");
      out.write("						<td><input type=\"text\" name=\"course-id\" required></td>\n");
      out.write("						<td><input type=\"text\" name=\"course-name\" \" required></td>\n");
      out.write("						<td><input type=\"number\" min=\"1.0\" max=\"5.0\" step=\"0.5\" name=\"course-credit\"required></td>\n");
      out.write("				 <!-- 		<td><input type=\"text\" name=\"teacher-name\"></td>  -->\n");
      out.write("						<td>\n");
      out.write("					<!-- 	    <label for=\"classes\">Assign a Course Teacher:</label>  -->\n");
      out.write("						<!-- 	<div class=\"custom-select\" > -->\n");
      out.write("				                    <select required name=\"course-teacher\" id=\"language\" style=\"width:200px; height:30px; font-size:17px;\">\n");
      out.write("									  <option value=\"\" disabled selected hidden>Choose a Teacher</option>\n");
      out.write("									  <option value=\"Moksedur_Rahman\" disabled>Moksedur_Rahman</option>\n");
      out.write("									  ");
 for(int l=0; l<teacherList.size(); l++){ 
      out.write("\n");
      out.write("									  	<option value=");
      out.print(teacherList.get(l).username );
      out.write('>');
      out.write(' ');
      out.print(teacherList.get(l).username );
      out.write("</option>\n");
      ...
      out.write("				</tbody>\n");
      out.write("			</table>\n");
      out.write("			<button type=\"submit\" name=\"add-now\">Add Now</button>\n");
      out.write("		</form>\n");
      out.write("	</main>\n");
      ...
      out.write("    		swal(\"Congrats\",\"Course Added Successfully\", \"success\");\n");
      out.write("    	}\n");
      out.write("    	else if(status==\"failed\"){\n");
      out.write("    		swal(\"Sorry\",\"An Error Occured\", \"error\");\n");
      out.write("    	}\n");
      out.write("    \n");
      out.write("    </script>\n");
      out.write("</body>\n");
